<div class="col-span-1 p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
    <div class="flex items-center justify-between gap-4 mb-2">
        ...
        <button id="dropdown-button-{{ $activity['id'] }}" data-dropdown-toggle="dropdown-{{ $activity['id'] }}" value="{{ $activity['id'] }}" class="open_form inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
