<div class="min-w-52 w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
   ...
   <div class="flex justify-between mb-5">
     <div>
         <h5 class="leading-none font-bold pb-2 text-3xl text-gray-500 dark:text-gray-400">Payments Overview</h5>
     </div>
      <button
   ...
   <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between mt-5">
      <div class="flex justify-between items-center pt-5">
         <div class="border-stroke py-2 dark:border-strokedark xsm:w-1/2 xsm:border-r">
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 text-center inline-flex items-center dark:hover:text-white">Received Amount</p>
            <h4 id="received-amount" class="mt-1 text-title-sm font-bold text-black dark:text-white"></h4>
         </div>
         <div class="py-2 xsm:w-1/2">
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-gray-900 text-center inline-flex items-center dark:hover:text-white">Due Amount</p>
